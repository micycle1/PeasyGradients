...
public final class ITP {
	...
	public static double[] itp2rgb(double[] itp) {
		double I = 1 * itp[0] + 0.00860904 * itp[1] + 0.11102963 * itp[2];
		double T = 1 * itp[0] + -0.00860904 * itp[1] + -0.11102963 * itp[2];
		double P = 1 * itp[0] + 0.56003134 * itp[1] + -0.32062717 * itp[2];
	...
	private static double EOTF(double N) {
		...
		double L = FastMath.pow(n / (c2 - c3 * V_p), m1B);
		double C = 10000 * L;
		return C;
	}
